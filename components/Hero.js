  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Gradient overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-primary-blue/80 via-primary-blue/85 to-accent-teal/75"></div>
      </div>
          ...
          >
            ...
            <span className="relative inline-block">
              ...
              <motion.div
                ...
                className="absolute bottom-0 left-0 w-full h-4 bg-accent-orange/40 -z-10 rounded-sm"
              />
            </span>{' '}
            <br className="hidden md:block" />
            <span className="text-3xl md:text-5xl lg:text-6xl text-accent-orange/90 font-semibold">
              {t('hero.titleSuffix')}
            </span>
          </motion.h1>
          ...
          <motion.div variants={itemVariants}>
            <motion.button
              ...
              className="bg-white text-primary-blue font-bold text-lg px-10 py-4 rounded-full 
                         ...
                         hover:bg-neutral-light transform inline-flex items-center"
            >
